...
typedef struct
{
    int x, y;                   /* if -1, then center the dialog */
...
int quick2_dialog_skip (quick_dialog_t * qd, int nskip);

/*** inline functions ****************************************************************************/

static inline int
quick2_dialog (quick_dialog_t * qd)
{
    return quick2_dialog_skip (qd, 1);
}
